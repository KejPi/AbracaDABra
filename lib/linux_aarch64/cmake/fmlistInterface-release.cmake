...
set_target_properties(fmlistInterface::fmlistInterface PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/linux_aarch64/libfmlistInterface.so.1.0.0"
  IMPORTED_SONAME_RELEASE "libfmlistInterface.so.1"
  )

list(APPEND _cmake_import_check_targets fmlistInterface::fmlistInterface )
list(APPEND _cmake_import_check_files_for_fmlistInterface::fmlistInterface "${_IMPORT_PREFIX}/linux_aarch64/libfmlistInterface.so.1.0.0" )
